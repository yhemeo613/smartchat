-- Unified provider migration: merge 4 columns into 3
-- ai_provider, ai_api_key, ai_base_url

-- Step 1: Add new columns
alter table public.profiles add column if not exists ai_provider text not null default 'openai';
...
-- Step 2: Migrate existing data (prefer OpenAI, fallback to Anthropic)
